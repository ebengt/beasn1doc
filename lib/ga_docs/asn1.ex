defmodule GaDocs.ASN1 do
  ...
  defp strings({key, value}), do: strings(key, value) |> Enum.join("\n")
  ...
  defp structures([], acc), do: acc

  defp structures(lines, acc) do
