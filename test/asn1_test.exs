defmodule GaDocs.ASN1Test do
  use ExUnit.Case

  test "find start" do
    [result | _] = content() |> GaDocs.ASN1.find_start() |> GaDocs.ASN1.find_start()
  ...
  test "structure compound" do
    result =
      content()
      |> GaDocs.ASN1.find_start()
      |> GaDocs.ASN1.find_start()
      |> GaDocs.ASN1.structure_one()
  ...
  test "structure compound as strings" do
    ...
    result = GaDocs.ASN1.strings("GPRSRecord", structure)
  ...
  test "structure integer" do
    ...
    result = GaDocs.ASN1.structure_one(lines)
  ...
  test "structure as strings" do
    ...
    result = GaDocs.ASN1.strings("AccessAvailabilityChangeReason", structure)
